...
#define CAN_ERD_INIT(min_priority, erd_chn, erd_id_type, erd_std_id, erd_ext_id, mod)   \
    {                                       \
    ERD_INIT(can_erd_ops, min_priority),    \
    (erd_chn),                              \
    (erd_id_type),                          \
    (erd_std_id),                           \
    (erd_ext_id),                           \
...
#define CAN_INIT(mod)   CAN_ERD_INIT(REP_DEBUG, CAN_CHANNEL0, STANDARD_ID, 0, 0, mod)
#define CAN(name, mod)    \
