...
#define STOWAD              (0x20)      /* Start Open-Wire ADC Conversions and Poll Status (All) */
    #define STOWAD_1            (STOWAD+1)  /* ...for Cell 1 */
    #define STOWAD_2            (STOWAD+2)  /* ...for Cell 2 */
    #define STOWAD_3            (STOWAD+3)  /* ...for Cell 3 */
    #define STOWAD_4            (STOWAD+4)  /* ...for Cell 4 */
    #define STOWAD_5            (STOWAD+5)  /* ...for Cell 5 */
    #define STOWAD_6            (STOWAD+6)  /* ...for Cell 6 */
    #define STOWAD_7            (STOWAD+7)  /* ...for Cell 7 */
    #define STOWAD_8            (STOWAD+8)  /* ...for Cell 8 */
    #define STOWAD_9            (STOWAD+9)  /* ...for Cell 9 */
    #define STOWAD_10           (STOWAD+10) /* ...for Cell 10 */
    #define STOWAD_11           (STOWAD+11) /* ...for Cell 11 */
    #define STOWAD_12           (STOWAD+12) /* ...for Cell 12 */
#define STTMPAD             (0x30)      /* Start Temperature ADC Conversions and Poll Status (All) */
    #define STTMPAD_EXT1        (STTMPAD+1) /* ... for External1 */
    #define STTMPAD_EXT2        (STTMPAD+2) /* ... for External2 */
    #define STTMPAD_INTERNAL    (STTMPAD+3) /* internal */
...
#define CDC_2000ms_VrefOff      (CDC_VAL6)  /* 2000ms UV/OV comparator period;  Vref powered down between msmts;        21ms cell voltage msmt time */
