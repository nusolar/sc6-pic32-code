...
/* define Digital I/O port to be used for 1-wire communication */
#define OW_PIN_ODC				ODCDbits.ODCD0		/* Open-drain Setting */
#define OW_PIN_DIRECTION		TRISDbits.TRISD0	/* Pin direction setting */
#define OW_WRITE_PIN			LATDbits.LATD0		/* Instruction to write to pin */
#define OW_READ_PIN				PORTDbits.RD0		/* Instruction to read from pin */
...
unsigned char FoundROM[32][8];	/* Table of found ROM codes, 8 bytes each */
